...
const SensetiveTextField: React.FC<SensetiveTextFieldProps> = (props) => {
    ...
    const toggleShowpassword = useCallback(() => setShowPassword(prevState => !prevState), [setShowPassword]);
    return <TextField {...props} type={showPassword ? 'text' : 'password'} InputProps={{
